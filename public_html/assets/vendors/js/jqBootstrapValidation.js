                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("pattern") !== undefined) {
                            message = "Incorreto<!-- data-validation-pattern-message to override -->";
                        ...
                        if ($this.attr("max") !== undefined || $this.attr("aria-valuemax") !== undefined) {
                            ...
                            message = "Máximo: '" + max + "'<!-- data-validation-max-message to override -->"; if ($this.data("validationMaxMessage")) {
                        ...
                        if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
                            ...
                            message = "Mínimo: '" + min + "'<!-- data-validation-min-message to override -->";
        ...
        validatorTypes: {
            ...
            max: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "Máximo: '" + result.max + "'";
                    if ($this.data("validation" + name + "Message")) {
            ...
            min: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "Mínimo: '" + result.min + "'";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
